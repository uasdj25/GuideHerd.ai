...
Every setting listed as Self-service both saves AND acts — the historical
"stored only" group (scheduling preferences, business hours) now shapes
real offers; see the Scheduling section.
...
| Setting | Status | Notes |
|---|---|---|
| Preferred attorneys | **Self-service** | Ranks offered times |
| Preferred days of week | **Self-service** | Ranks offered times |
| Morning / afternoon preference | **Self-service** | Ranks offered times |
| Preferred appointment length | **Self-service** | Ranks offered times |
| Business hours | **Self-service** | A hard rule: times outside them are never offered |
...
> **How scheduling settings shape real offers.**
>
> When your scheduling assistant asks GuideHerd which times to offer,
> GuideHerd first removes anything outside your **business hours** (a hard
> rule — if your rules exclude every available time, the caller is honestly
> offered nothing rather than something forbidden), then orders what's left
> by your **preferences** (preferences re-rank; they never hide times). No
> preferences set means times are offered in calendar order.
>
> One thing to confirm at onboarding: this applies to offers that flow
> through GuideHerd's selection step. Ask your GuideHerd contact to confirm
> your scheduling assistant is connected to it — if it isn't yet, these
> settings save but won't shape offers until it is.
>
