...
import { processIntake } from '../lib/processor.js';
...
export default function IntakeForm() {
  ...
  function handleSubmit(e) {
    ...
    if (!form.firstName.trim() || !form.lastName.trim() || !form.email.trim() || !form.matterDescription.trim()) {
    ...
    // processIntake runs synchronously in the browser — no API call needed
    setTimeout(() => {
      try {
        const { analysis, drafts } = processIntake(form);
        const lead = {
    ...
    }, 600); // brief artificial delay so the "Processing…" state is visible
  }
  ...
  return (
    <main className="page" style={{ maxWidth: 780 }}>
      <div className="disclaimer-banner">
        ⚠️&nbsp;
        <strong>Demo form only.</strong>&nbsp;Submitting this form does not create an
        attorney-client relationship and does not constitute legal advice. This is a
        demonstration system with fictional data.
      </div>
      ...
      <form onSubmit={handleSubmit}>
          ...
          <div className="form-section">
            ...
            <div className="form-row">
              <div className="form-group">
                <label className="form-label">
                  Describe Your Legal Matter <span className="required">*</span>
                </label>
                <textarea
                ...
                <span className="form-hint">
                  The more detail you provide, the better we can evaluate your matter.
                </span>
              </div>
            </div>
            <div className="form-row">
            ...
            <div className="form-row cols-2">
              <div className="form-group">
                ...
                <input
                  className="form-input"
                  value={form.estimatedDamages}
                  onChange={set('estimatedDamages')}
          ...
          <div className="form-section" style={{ marginBottom: 0 }}>
            ...
            <div className="form-row cols-2">
              <div className="form-group">
                ...
                <input
                  className="form-input"
                  value={form.priorAttorney}
                  onChange={set('priorAttorney')}
                  placeholder="Name of attorney, or 'None'"
                />
                <span className="form-hint">
                  If you have or had an attorney on this matter, please list them.
                </span>
              </div>
              <div className="form-group">
        ...
        <div style={{
          ...
          relationship. No attorney will be assigned to your matter until a formal engagement
          agreement is signed. Do not include highly sensitive information in this form.
        </div>
